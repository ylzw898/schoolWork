...
<template>
 <div id="app">
   ...
   <el-table :data="tableData" style="font-size: 18px; width: 100%">
     <el-table-column prop="img" label="图片" min-width="17%" >
       <template   slot-scope="scope">
         <img :src="scope.row.img"  width="186" height="140" />
       </template>
     </el-table-column>
     <el-table-column prop="region" label="城区" min-width="7%"></el-table-column>
     <el-table-column prop="floor" label="楼层" min-width="5%"></el-table-column>
     <el-table-column prop="renovation" label="装修" min-width="7%"></el-table-column>
     <el-table-column prop="elevator" label="电梯" min-width="8%"></el-table-column>
     <el-table-column prop="garden" label="小区" min-width="16%"></el-table-column>
     <el-table-column prop="layout" label="布局" min-width="10%"></el-table-column>
     <el-table-column prop="price" label="价格(万元/套)" min-width="10%"></el-table-column>
     <el-table-column prop="size" label="面积(㎡)" min-width="10%"></el-table-column>
     <el-table-column prop="phone" label="电话" min-width="10%"></el-table-column>
   </el-table>
